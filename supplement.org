...
The example data analysis included in the paper was conducted as follows.
\scriptsize
#+BEGIN_SRC R :session *R-org* :results output :exports both
library(regmedint)
## Model fitting
