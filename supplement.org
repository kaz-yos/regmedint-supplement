...
#+BEGIN_SRC R :session *R-org* :results output graphics file :file ./source/figure.pdf :exports both
res_mreg_linear_yreg_linear <-
  regmedint(data = vv2015,
            yvar = "y", avar = "x", mvar = "m", cvar = "c", eventvar = NULL,
            a0 = 0, a1 = 1, m_cde = 1, c_cond = 0.5,
            mreg = "linear", yreg = "linear",
            interaction = TRUE, casecontrol = FALSE)

res_mreg_linear_yreg_logistic <-
  regmedint(data = vv2015,
            yvar = "event", avar = "x", mvar = "m", cvar = "c", eventvar = NULL,
            a0 = 0, a1 = 1, m_cde = 1, c_cond = 0.5,
            mreg = "linear", yreg = "logistic",
            interaction = TRUE, casecontrol = FALSE)

res_mreg_logistic_yreg_linear <-
  regmedint(data = vv2015,
            yvar = "y", avar = "x", mvar = "m", cvar = "c", eventvar = NULL,
            a0 = 0, a1 = 1, m_cde = 1, c_cond = 0.5,
            mreg = "logistic", yreg = "linear",
            interaction = TRUE, casecontrol = FALSE)

res_mreg_logistic_yreg_logistic <-
  regmedint(data = vv2015,
            yvar = "event", avar = "x", mvar = "m", cvar = "c", eventvar = NULL,
            a0 = 0, a1 = 1, m_cde = 1, c_cond = 0.5,
...
res_mreg_linear_yreg_linear_int_false <-
  regmedint(data = vv2015,
            yvar = "y", avar = "x", mvar = "m", cvar = "c", eventvar = NULL,
            a0 = 0, a1 = 1, m_cde = 1, c_cond = 0.5,
            mreg = "linear", yreg = "linear",
...
res_mreg_linear_yreg_logistic_int_false <-
  regmedint(data = vv2015,
            yvar = "event", avar = "x", mvar = "m", cvar = "c", eventvar = NULL,
            a0 = 0, a1 = 1, m_cde = 1, c_cond = 0.5,
            mreg = "linear", yreg = "logistic",
...
res_mreg_logistic_yreg_linear_int_false <-
  regmedint(data = vv2015,
            yvar = "y", avar = "x", mvar = "m", cvar = "c", eventvar = NULL,
            a0 = 0, a1 = 1, m_cde = 1, c_cond = 0.5,
            mreg = "logistic", yreg = "linear",
...
res_mreg_logistic_yreg_logistic_int_false <-
  regmedint(data = vv2015,
            yvar = "event", avar = "x", mvar = "m", cvar = "c", eventvar = NULL,
            a0 = 0, a1 = 1, m_cde = 1, c_cond = 0.5,
            mreg = "logistic", yreg = "logistic",
...
c_cond_min <- min(vv2015$c)
c_cond_max <- max(vv2015$c)
c_cond_grid <- seq(from = c_cond_min, to = c_cond_max, by = 0.1)

library(tidyverse)

res <- tibble(mreg = rep(c("linear","linear","logistic","logistic"), 2),
              yreg = rep(c("linear","logistic","linear","logistic"), 2),
              interaction = rep(c(TRUE, FALSE), each = 4),
              fit = list(res_mreg_linear_yreg_linear,
                         res_mreg_linear_yreg_logistic,
                         res_mreg_logistic_yreg_linear,
                         res_mreg_logistic_yreg_logistic,
                         res_mreg_linear_yreg_linear_int_false,
...
## Plot
res %>%
  filter(name %in% c("te","pnde","tnie"), interaction == TRUE) %>%
  ggplot(mapping = aes(x = c_cond, y = value, group = name, color = name)) +
  geom_line() +
  facet_grid(mreg ~ yreg) +
  theme_bw() +
...
## Plot
res %>%
  filter(name %in% c("te","pnde","tnie"), interaction == FALSE) %>%
  ggplot(mapping = aes(x = c_cond, y = value, group = name, color = name)) +
  geom_line() +
  facet_grid(mreg ~ yreg) +
  theme_bw() +
