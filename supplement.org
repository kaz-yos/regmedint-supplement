...
The conditional direct effect (CDE(m)), the effect of chaning the treatment level from the reference level $a_{0}$ to the level of interest $a_{1}$ while fixing the mediator at $m$ is the following.
